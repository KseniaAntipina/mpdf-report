...
<div class="page page5" style="page-break-before:left;">
    <h2 class="gray" style="margin-bottom:60px;padding-left:53px;"> На чем основывается данное исследование</h2>
...
<div class="page page6" style="page-break-before:left;">
    ...
    <div class="content-text">
        ...
        <div>
            ...
            <p style="width:552px;height:10px;margin-bottom:20px;">
            <img src=\'/assets/gradient1.png\'>
            </p>
        </div>

        <p class="risk-title" style="margin-bottom:5px;">Среднепопуляционный риск</p>
